...
class TextAlignedTokenizer(nn.Module):
    ...
    def from_checkpoint(cls, ckpt, load_teacher=True, **kwargs):
        ...
        # Ensure output_hidden_states is enabled after loading
    ...
    def encode(self, x, **kwargs):
        ...
        if encoder_output.hidden_states is None:
            # Fallback: use last_hidden_state if hidden_states is None
            vq_feats = encoder_output.last_hidden_state
        else:
            vq_feats = encoder_output.hidden_states[self.select_layer_id]
